  ...
  return [
    {
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Outdoor courses', link: '/en/documentation/data-provider/grw-outdoor-courses-provider' },
          { text: 'Outdoor course', link: '/en/documentation/data-provider/grw-outdoor-course-provider' },
          { text: 'Outdoor sites', link: '/en/documentation/data-provider/grw-outdoor-sites-provider' },
          { text: 'Outdoor site', link: '/en/documentation/data-provider/grw-outdoor-site-provider' },
