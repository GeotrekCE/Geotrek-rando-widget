  ...
  return [
    {
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Plusieurs parcours outdoor', link: '/documentation/data-provider/grw-outdoor-courses-provider' },
          { text: 'Parcours outdoor', link: '/documentation/data-provider/grw-outdoor-course-provider' },
          { text: 'Sites outdoor', link: '/documentation/data-provider/grw-outdoor-sites-provider' },
          { text: 'Site outdoor', link: '/documentation/data-provider/grw-outdoor-site-provider' },
