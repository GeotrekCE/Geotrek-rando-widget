...
const defaultTranslate: AvailableTranslations = {
  ...
  es: {
    ...
    recommendedParking: 'Estacionamiento recomendado',
    environmentalSensitiveAreas: 'Zonas ambientalmente sensibles',
    informationPlaces: 'Puntos de información',
    accessibility: 'Accesibilidad',
    accessibilityLevel: 'Grado de accesibilidad',
    accessibilitySlope: 'Desnivel',
    accessibilityWidth: 'Anchura',
    ...
    options: {
      ...
      informationPlaces: 'Servicios de información',
      pois: 'Patrimonio',
      steps: 'Stapas',
    ...
    relatedOutdoorCourses: (relatedOutdoorCoursesLength: number) => `Itinerario (${relatedOutdoorCoursesLength})`,
    cardinalPoints: { n: 'Norte', ne: 'Noreste', e: 'Est', se: 'Sureste', s: 'Sur', sw: 'Suroeste', w: 'Oeste', nw: 'Noroeste' },
    placeholderDifficulties: 'Seleccione una o varias dificultades',
    placeholderDurations: 'Seleccione una o varias duraciones',
    placeholderLengths: 'Seleccione una o varias duraciones',
    placeholderElevations: 'Seleccione uno o varios desniveles',
    ...
    onlyOfflineTreks: 'Mostrar sólo rutas offline',
